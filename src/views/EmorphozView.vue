    ...
    <main>
        ...
        <div class="bg-gray-200 h-full w-full">
            ...
            <p class="mt-20 font-montserrat xl:text-xl pb-48 xl:ml-48 text-center ml-10 mr-10 z-10">Pour le choix de la
                ...
                2 principales: Audiowide et Trap.


                Pour la typographie Audiowide, elle a été utilisée pour les gros titres du site puisque c’est une
                typographie très futuriste comprenant des courbes spécialement prévues pour créer cet effet. C’est pour cela
                également qu’elle est utilisée pour la création du logo d’emorphoz.


                Enfin, pour la typographie Trap elle a été utilisée pour tous les autres titres restants sur le site. En
                effet, trap est une police très lisible, ce qui est parfait pour la compréhension. Également, elle dispose
